...
# NOTE: external network dependency (source from a raw GitHub gist URL) - a
# portability/reproducibility risk. Also effectively dead: the local
# fit_dist() redefinition immediately below shadows whatever this pulls in.
# Flagged, not fixed, during the code/ reorganization.
...
# BROKEN: simulated_data is a plain numeric vector (from rmetalog() above),
# not a data frame with a $pH column - this call would error. Flagged, not
# fixed, during the code/ reorganization.
