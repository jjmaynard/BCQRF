...
# BROKEN: simulate_and_perturb_soil_profiles() is defined earlier in this file
# taking only (soil_profile), not 4 args - this call would error. Flagged, not
# fixed, during the code/ reorganization (this is a scratch/ad hoc test harness).
